...
@Component({
    selector: 'gl-salary-education-change-table',
    templateUrl: './salary-education-change-table.component.html',
    styleUrls: ['./salary-education-change-table.component.scss'],
})
export class SalaryEducationChangeTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    causeChangeEditAllIfy = {
        ...
        _loadEditFields: async () => {
            ...
            const scheme = await this.commonService
                .getFieldSchemeConent('sygz_xlbb001')
                .toPromise();
