...
@Component({
    selector: 'gl-salary-floating-change-list',
    templateUrl: './salary-floating-change-list.component.html',
    styleUrls: ['./salary-floating-change-list.component.scss'],
})
export class SalaryFloatingChangeListComponent implements OnInit, AfterViewInit {
    constructor(
