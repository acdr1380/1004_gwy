...
@Component({
    selector: 'gl-salary-high-low-manager',
    templateUrl: './salary-high-low-manager.component.html',
    styleUrls: ['./salary-high-low-manager.component.scss'],
})
export class SalaryHighLowManagerComponent implements OnInit {
    /**
     * 路由参数
     */
