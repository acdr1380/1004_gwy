...
import { SalaryHighLowListComponent } from './salary-high-low-list.component';
import { NzInputModule } from 'ng-zorro-antd/input';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryHighLowListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryHighLowListComponent],
})
export class SalaryHighLowListModule { }
