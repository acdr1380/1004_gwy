...
import { CivilPunishmentReduceListComponent } from './civil-punishment-reduce-list.component';
...
@NgModule({
    declarations: [CivilPunishmentReduceListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [CivilPunishmentReduceListComponent],
})
export class CivilPunishmentReduceListModule {}
