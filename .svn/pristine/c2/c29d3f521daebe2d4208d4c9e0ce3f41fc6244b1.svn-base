...
@Component({
    selector: 'gl-salary-floating-change-start',
    templateUrl: './salary-floating-change-start.component.html',
    styleUrls: ['./salary-floating-change-start.component.scss'],
})
export class SalaryFloatingChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
