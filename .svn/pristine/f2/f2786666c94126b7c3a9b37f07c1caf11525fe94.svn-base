...
import { SalaryHighLowService } from '../salary-high-low.service';
import { ResultService } from 'app/client-page/policy/policy-query/result/result.service';

@Component({
    selector: 'gl-salary-high-low-start',
    templateUrl: './salary-high-low-start.component.html',
    styleUrls: ['./salary-high-low-start.component.scss'],
})
export class SalaryHighLowStartComponent implements OnInit {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryHighLowService,
