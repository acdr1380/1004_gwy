...
import { CivilHighLowTableComponent } from './civil-high-low-table.component';
...
@NgModule({
    declarations: [CivilHighLowTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
        ...
        SalaryGZ07Module,
        DatetimeInputModule,
        OperSalaryInfoModule,
        ExcelControlModule,
        OperSelectPersonModule,
        SalaryGZDA07JBTModule,
    ],
    providers: [DatePipe],
    exports: [CivilHighLowTableComponent],
})
export class CivilHighLowTableModule {}
