...
import { SalaryCivilAllowanceChangeTableComponent } from './salary-civil-allowance-change-table.component';
import { AllowEditComponent } from './allow-edit/allow-edit.component';
@NgModule({
    declarations: [SalaryCivilAllowanceChangeTableComponent, AllowEditComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryCivilAllowanceChangeTableComponent],
})
export class SalaryCivilAllowanceChangeTableModule {}
