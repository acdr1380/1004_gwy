...
@Component({
    ...
    selector: 'salary-civil-initialize-list-form',
    templateUrl: './salary-civil-initialize-list-form.component.html',
    styleUrls: ['./salary-civil-initialize-list-form.component.scss'],
})
export class SalaryCivilInitializeListFormComponent implements OnInit, AfterViewInit {
    constructor(
