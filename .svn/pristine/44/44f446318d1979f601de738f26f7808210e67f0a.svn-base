...
@Component({
    selector: 'gl-salary-sick-leave-manager',
    templateUrl: './salary-sick-leave-manager.component.html',
    styleUrls: ['./salary-sick-leave-manager.component.scss'],
})
export class SalarySickLeaveManagerComponent implements OnInit {
    /**
     * 路由参数
     */
