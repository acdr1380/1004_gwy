...
@Component({
    selector: 'gl-salary-civil-allowance-change-manager',
    templateUrl: './salary-civil-allowance-change-manager.component.html',
    styleUrls: ['./salary-civil-allowance-change-manager.component.scss'],
})
export class SalaryCivilAllowanceChangeManagerComponent implements OnInit {
    /**
     * 路由参数
     */
