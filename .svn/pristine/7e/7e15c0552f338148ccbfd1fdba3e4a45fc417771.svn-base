...
import { LevelRiseListComponent } from './level-rise-list.component';
...
@NgModule({
    declarations: [LevelRiseListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [LevelRiseListComponent],
})
export class LevelRiseListModule {}
