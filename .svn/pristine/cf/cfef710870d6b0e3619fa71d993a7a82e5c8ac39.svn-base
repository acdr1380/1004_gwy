...
@Component({
    selector: 'gl-salary-sick-leave-start',
    templateUrl: './salary-sick-leave-start.component.html',
    styleUrls: ['./salary-sick-leave-start.component.scss'],
})
export class SalarySickLeaveStartComponent implements OnInit {
    /**
     * 路由参数
     */
