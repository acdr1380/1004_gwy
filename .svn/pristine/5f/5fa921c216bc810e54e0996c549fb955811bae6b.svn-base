...
import { SalaryOtherReduceService } from '../salary-other-reduce.service';

@Component({
    selector: 'gl-salary-other-table',
    templateUrl: './salary-other-table.component.html',
    styleUrls: ['./salary-other-table.component.scss'],
})
export class SalaryOtherTableComponent implements OnInit {
    isFullScreen = false;
    ...
    personTableIfy = {
        ...
        inputChange: (row, field) => {
            ...
            const params = {
                keyId: row[`${this.tableHelper.getTableCode('A01')}_ID`],
                childId: tableId === 'A01' ? '-1' : row.A30Id,
                jobId: this.jobStepInfo.jobId,
                jobStepId: this.jobStepInfo.jobStepId,
                jobDataId: this.jobStepInfo.jobDataId,
                changeType: WfDataChangeTypeEnum.MODIFY,
    ...
    constructor(
        ...
        private service: SalaryOtherReduceService,
