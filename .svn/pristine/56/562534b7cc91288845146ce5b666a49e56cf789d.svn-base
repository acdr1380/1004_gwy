...
@Component({
    selector: 'gl-tibet-person-initialize-start',
    templateUrl: './tibet-person-initialize-start.component.html',
    styleUrls: ['./tibet-person-initialize-start.component.scss'],
})
export class TibetPersonInitializeStartComponent implements OnInit {
    /**
     * 路由参数
     */
    ...
    @ViewChild('operConfirmTemp', { static: true }) _operConfirmTemp: ElementRef;
    /**
     * 外层步骤
     */
    operBaseOptionIfy = {
        ...
        evtStepChange: index => {
            ...
            switch (index) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    this.operBaseOptionIfy.list[index].template = this._operConfirmTemp;
                    break;
            }
        },
    };
