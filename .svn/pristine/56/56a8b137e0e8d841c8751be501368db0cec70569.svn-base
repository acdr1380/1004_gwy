...
@Component({
    selector: 'gl-tibet-person-register-manager',
    templateUrl: './tibet-person-register-manager.component.html',
    styleUrls: ['./tibet-person-register-manager.component.scss'],
})
export class TibetPersonRegisterManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
