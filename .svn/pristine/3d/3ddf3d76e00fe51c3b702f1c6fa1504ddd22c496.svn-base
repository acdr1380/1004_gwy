...
@Component({
    selector: 'gl-exam-adjust-child-order',
    templateUrl: './exam-adjust-child-order.component.html',
    styleUrls: ['./exam-adjust-child-order.component.scss'],
})
export class ExamAdjustChildOrderComponent implements OnInit {
