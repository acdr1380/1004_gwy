...
@Component({
    selector: 'standing-change-table',
    templateUrl: './standing-change-table.component.html',
    styleUrls: ['./standing-change-table.component.scss'],
})
export class StandingChangeTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    standingWorkChange: WorkChangeComponent;
    /**
     * 工龄情况
     */
    conditionDrw = <any>{
