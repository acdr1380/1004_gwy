...
import { SalaryEducationChangeListComponent } from './salary-education-change-list.component';
...
@NgModule({
    declarations: [SalaryEducationChangeListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryEducationChangeListComponent],
})
export class SalaryEducationChangeListModule { }
