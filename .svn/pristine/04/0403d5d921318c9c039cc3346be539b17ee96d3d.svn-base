...
export class PersonOrderComponent implements OnInit {
    ...
    personOrderAdjustIfy = {
        ...
        find: {
            ...
            evtSearch: event => {
                if (event) {
                    this.personOrderAdjustIfy.find.searchList =
                        this.personOrderAdjustIfy.personList.data
        ...
        handle: {
            ...
            evtMove: (direction: 0 | 1) => {
                ...
                const data = {
                    $MOVE_TYPE$: direction,
                    // DATA_1002_PERSON_A01_ID: item.DATA_1002_PERSON_A01_ID,
                };
                data[`${this.tableHelper.getTableCode('A01')}_ID`] =
                    item[`${this.tableHelper.getTableCode('A01')}_ID`];
                this.service.adjustSort(data).subscribe(json => {
