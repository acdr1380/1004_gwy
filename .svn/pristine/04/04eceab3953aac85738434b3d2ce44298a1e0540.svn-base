...
import { SalaryCivilDeathService } from '../salary-civil-death.service';

@Component({
    selector: 'gl-salary-civil-death-manager',
    templateUrl: './salary-civil-death-manager.component.html',
    styleUrls: ['./salary-civil-death-manager.component.scss'],
})
export class SalaryCivilDeathManagerComponent implements OnInit {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilDeathService,
