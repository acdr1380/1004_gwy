...
import { SalaryFloatingChangeListComponent } from './salary-floating-change-list.component';
...
@NgModule({
    declarations: [SalaryFloatingChangeListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryFloatingChangeListComponent],
})
export class SalaryFloatingChangeListModule { }
