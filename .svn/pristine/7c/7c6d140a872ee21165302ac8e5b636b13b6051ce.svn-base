...
@Component({
    selector: 'gl-salary-post-table',
    templateUrl: './salary-post-table.component.html',
    styleUrls: ['./salary-post-table.component.scss'],
})
export class SalaryPostTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
