...
import { JBT_TABLE } from './career-allowance-field/JBT';
import { CareerAllowEditComponent } from './career-allow-edit/career-allow-edit.component';
...
export class AllowanceChangeTableComponent implements OnInit, AfterViewInit {
    ...
    _allowEditComponent: CareerAllowEditComponent;
