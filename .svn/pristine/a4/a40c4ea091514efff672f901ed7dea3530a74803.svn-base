...
@Component({
  selector: 'gl-tibet-person-enter-start',
  templateUrl: './tibet-person-enter-start.component.html',
  styleUrls: ['./tibet-person-enter-start.component.scss']
})
export class TibetPersonEnterStartComponent implements OnInit  {
    /**
     * 路由参数
     */
