...
import { TibetAnnualAssessTableComponent } from './tibet-annual-assess-table.component';
...
@NgModule({
    declarations: [TibetAnnualAssessTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [TibetAnnualAssessTableComponent],
})
export class TibetAnnualAssessTableModule { }
