...
@Component({
    ...
    selector: 'civil-post-list',
    templateUrl: './civil-post-list.component.html',
    styleUrls: ['./civil-post-list.component.scss'],
})
export class CivilPostListComponent implements OnInit, AfterViewInit {
    constructor(
