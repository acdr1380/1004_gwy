...
import { SalaryHighLowTableComponent } from './salary-high-low-table.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryHighLowTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryHighLowTableComponent],
})
export class SalaryHighLowTableModule { }
