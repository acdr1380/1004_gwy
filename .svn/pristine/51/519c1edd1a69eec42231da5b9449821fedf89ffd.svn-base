...
@Component({
    selector: 'app-salary-initialize-start',
    templateUrl: './salary-initialize-start.component.html',
    styleUrls: ['./salary-initialize-start.component.scss'],
})
export class SalaryInitializeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
