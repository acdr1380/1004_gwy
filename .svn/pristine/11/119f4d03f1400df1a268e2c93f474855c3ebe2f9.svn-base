...
import { CivilLevelRiseService } from './civil-level-rise.service';
...
@Component({
    selector: 'app-civil-level-rise',
    templateUrl: './civil-level-rise.component.html',
    styleUrls: ['./civil-level-rise.component.scss'],
})
export class CivilLevelRiseComponent implements OnInit, OnDestroy {
    /**
     * 用户信息
     */
    userInfo: any = {};
    ...
    constructor(
        ...
        private service: CivilLevelRiseService,
