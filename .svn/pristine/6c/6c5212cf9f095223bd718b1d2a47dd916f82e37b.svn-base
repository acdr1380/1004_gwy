...
@Component({
    selector: 'gl-salary-civil-death-list',
    templateUrl: './salary-civil-death-list.component.html',
    styleUrls: ['./salary-civil-death-list.component.scss'],
    providers: [WfTableHelper],
})
export class SalaryCivilDeathListComponent implements OnInit {
    constructor(
