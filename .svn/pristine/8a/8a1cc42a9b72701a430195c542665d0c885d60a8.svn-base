...
import { SalaryCivilEducationChangeService } from '../salary-civil-education-change.service';
...
@Component({
    selector: 'app-civil-post-change-manager',
    templateUrl: './civil-education-change-manager.component.html',
    styleUrls: ['./civil-education-change-manager.component.scss'],
})
export class CivilEducationChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilEducationChangeService,
