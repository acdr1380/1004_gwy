...
import { SalaryCivilHighLowService } from '../salary-civil-high-low.service';
@Component({
    selector: 'app-civil-high-low-change-manager',
    templateUrl: './salary-civil-high-low-manager.component.html',
    styleUrls: ['./salary-civil-high-low-manager.component.scss'],
})
export class SalaryCivilHighLowManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilHighLowService,
