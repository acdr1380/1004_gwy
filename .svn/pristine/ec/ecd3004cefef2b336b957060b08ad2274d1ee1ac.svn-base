...
import { RankRiseStartComponent } from './rank-rise-start.component';
...
const route: Routes = [{ path: '', component: RankRiseStartComponent }];

@NgModule({
    declarations: [RankRiseStartComponent],
    imports: [
        CommonModule,
...
export class SalaryRankRiseStartModule {}
