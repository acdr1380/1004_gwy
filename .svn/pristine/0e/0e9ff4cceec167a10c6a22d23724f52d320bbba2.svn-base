...
@Component({
    selector: 'gl-tibet-exam-record-manager',
    templateUrl: './tibet-exam-record-manager.component.html',
    styleUrls: ['./tibet-exam-record-manager.component.scss'],
})
export class TibetExamRecordManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
