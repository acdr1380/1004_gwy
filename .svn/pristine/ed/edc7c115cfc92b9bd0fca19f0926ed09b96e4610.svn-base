...
@Component({
    selector: 'gl-salary-death-start',
    templateUrl: './salary-death-start.component.html',
    styleUrls: ['./salary-death-start.component.scss'],
})
export class SalaryDeathStartComponent implements OnInit {
    /**
     * 路由参数
     */
