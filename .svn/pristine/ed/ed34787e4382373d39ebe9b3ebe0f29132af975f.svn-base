...
import { SalaryCivilPunishmentReduceService } from '../salary-civil-punishment-reduce.service';
...
@Component({
    selector: 'app-civil-punishment-reduce-manager',
    templateUrl: './civil-punishment-reduce-manager.component.html',
    styleUrls: ['./civil-punishment-reduce-manager.component.scss'],
})
export class CivilPunishmentReduceManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilPunishmentReduceService,
