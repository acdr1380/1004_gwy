...
@Component({
    selector: 'gl-salary-post-list',
    templateUrl: './salary-post-list.component.html',
    styleUrls: ['./salary-post-list.component.scss'],
})
export class SalaryPostListComponent implements OnInit, AfterViewInit {
    constructor(
