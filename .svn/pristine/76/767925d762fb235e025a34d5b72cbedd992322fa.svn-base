...
@Component({
    selector: 'app-salary-civli-inner-transfer-manager',
    templateUrl: './salary-civli-inner-transfer-manager.component.html',
    styleUrls: ['./salary-civli-inner-transfer-manager.component.scss'],
})
export class SalaryCivliInnerTransferManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
    ...
    operBaseOptionIfy = {
        ...
        evtArchives: () => {
            this.modalService.confirm({
                nzTitle: '系统提示?',
                nzContent: `<b style="color: red;">您确定归档该业务么？</b>`,
                nzOkText: '确定',
                nzOkType: 'danger',
                nzOnOk: () => {
                    const data = {
