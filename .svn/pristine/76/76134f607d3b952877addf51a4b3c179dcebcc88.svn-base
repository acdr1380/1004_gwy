...
import { SalaryRetireService } from '../salary-retire.service';
...
@Component({
    selector: 'gl-salary-retire-manager',
    templateUrl: './salary-retire-manager.component.html',
    styleUrls: ['./salary-retire-manager.component.scss'],
})
export class SalaryRetireManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryRetireService,
