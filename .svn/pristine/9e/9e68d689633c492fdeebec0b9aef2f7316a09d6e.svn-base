...
@Component({
    selector: 'gl-salary-civil-define-level-manager',
    templateUrl: './salary-civil-define-level-manager.component.html',
    styleUrls: ['./salary-civil-define-level-manager.component.scss'],
})
export class SalaryCivilDefineLevelManagerComponent implements OnInit {
    /**
     * 路由参数
     */
