...
@Component({
    selector: 'gl-tibet-person-initialize-manager',
    templateUrl: './tibet-person-initialize-manager.component.html',
    styleUrls: ['./tibet-person-initialize-manager.component.scss'],
})
export class TibetPersonInitializeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
