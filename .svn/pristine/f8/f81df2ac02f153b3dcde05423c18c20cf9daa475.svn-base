...
import { SalaryCivilOtherReduceListComponent } from './salary-civil-other-reduce-list.component';
import { NzInputModule } from 'ng-zorro-antd/input';
@NgModule({
    declarations: [SalaryCivilOtherReduceListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilOtherReduceListComponent],
})
export class SalaryCivilOtherReduceListModule {}
