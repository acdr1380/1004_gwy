...
@Component({
    selector: 'gl-allowance-change-start',
    templateUrl: './allowance-change-start.component.html',
    styleUrls: ['./allowance-change-start.component.scss'],
})
export class AllowanceChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
