...
import { SalaryFloatingChangeTableComponent } from './salary-floating-change-table.component';
...
@NgModule({
    declarations: [SalaryFloatingChangeTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryFloatingChangeTableComponent],
})
export class SalaryFloatingChangeTableModule { }
