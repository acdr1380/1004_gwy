...
import { SalaryCivilRetireService } from '../salary-civil-retire.service';
...
@Component({
    selector: 'gl-salary-civil-retire-manager',
    templateUrl: './salary-civil-retire-manager.component.html',
    styleUrls: ['./salary-civil-retire-manager.component.scss'],
})
export class SalaryCivilRetireManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilRetireService,
