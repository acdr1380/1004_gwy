...
import { TibetPersonInitializeService } from '../tibet-person-initialize.service';

@Component({
    selector: 'gl-tibet-person-initialize-list',
    templateUrl: './tibet-person-initialize-list.component.html',
    styleUrls: ['./tibet-person-initialize-list.component.scss'],
})
export class TibetPersonInitializeListComponent implements OnInit, AfterViewInit {
    constructor(
        private cdr: ChangeDetectorRef,
        private workflowService: WorkflowService,
        private commonService: CommonService,
        private tableHelper: WfTableHelper,
        private service: TibetPersonInitializeService
    ) {}
