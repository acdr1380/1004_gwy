...
@Component({
    ...
    selector: 'civil-high-low-table',
    templateUrl: './civil-high-low-table.component.html',
    styleUrls: ['./civil-high-low-table.component.scss'],
})
export class CivilHighLowTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    causeChangeEditAllIfy = {
        ...
        _loadEditFields: async () => {
            ...
            const scheme = await this.commonService
                .getFieldSchemeConent('gddgzyw_gwy01')
                .toPromise();
