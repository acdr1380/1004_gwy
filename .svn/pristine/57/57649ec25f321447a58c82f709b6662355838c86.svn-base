...
import { LevelRiseService } from './level-rise.service';
...
@Component({
    selector: 'app-level-rise',
    templateUrl: './level-rise.component.html',
    styleUrls: ['./level-rise.component.scss'],
})
export class LevelRiseComponent implements OnInit, OnDestroy {
    /**
     * 用户信息
     */
    userInfo: any = {};
    ...
    operResourceIfy = {
         ...
         * 跳转业务界面
         */
        _redirectOperPage: async (wfId, params: any = {}) => {
            if (params.jobStepState === JobStepStateEnum.PENDING) {
                const _loading = this.loading.show();

                params = await this.workflowService
                    .process(wfId, {
                        jobId: params.jobId,
    ...
    constructor(
        ...
        private service: LevelRiseService,
