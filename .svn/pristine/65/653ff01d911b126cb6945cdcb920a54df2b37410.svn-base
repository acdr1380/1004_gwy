...
import { TibetPersonQuitTableComponent } from './tibet-person-quit-table.component';
import { NzTabsModule } from 'ng-zorro-antd/tabs';


@NgModule({
    declarations: [TibetPersonQuitTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [TibetPersonQuitTableComponent],
})
export class TibetPersonQuitTableModule { }
