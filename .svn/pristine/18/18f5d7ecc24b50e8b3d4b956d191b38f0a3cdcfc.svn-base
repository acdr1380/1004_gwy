...
@Component({
    selector: 'gl-salary-death-table',
    templateUrl: './salary-death-table.component.html',
    styleUrls: ['./salary-death-table.component.scss'],
})
export class SalaryDeathTableComponent implements OnInit {
    isFullScreen = false;
