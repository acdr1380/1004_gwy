...
import { CivilPostListComponent } from './civil-post-list.component';
...
@NgModule({
    declarations: [CivilPostListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [CivilPostListComponent],
})
export class CivilPostListModule {}
