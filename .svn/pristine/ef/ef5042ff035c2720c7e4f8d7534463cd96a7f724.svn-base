...
@Component({
    selector: 'gl-salary-civil-define-level-list',
    templateUrl: './salary-civil-define-level-list.component.html',
    styleUrls: ['./salary-civil-define-level-list.component.scss'],
})
export class SalaryCivilDefineLevelListComponent implements OnInit {
    constructor(
