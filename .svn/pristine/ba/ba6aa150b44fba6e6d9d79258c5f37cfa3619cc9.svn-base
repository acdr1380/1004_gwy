...
@Component({
    ...
    templateUrl: './salary-civil-level-rise-manager.component.html',
    styleUrls: ['./salary-civil-level-rise-manager.component.scss'],
})
export class SalaryCivilLevelRiseManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
