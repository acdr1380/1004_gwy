...
import { SalarySickLeaveListComponent } from './salary-sick-leave-list.component';

@NgModule({
    declarations: [SalarySickLeaveListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalarySickLeaveListComponent],
})
export class SalarySickLeaveListModule {}
