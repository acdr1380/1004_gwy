...
import { SalaryOtherListComponent } from './salary-other-list.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryOtherListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryOtherListComponent],
})
export class SalaryOtherListModule { }
