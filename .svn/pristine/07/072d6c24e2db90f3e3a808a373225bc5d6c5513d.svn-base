...
@Component({
    ...
    selector: 'civil-punishment-reduce-table',
    templateUrl: './civil-punishment-reduce-table.component.html',
    styleUrls: ['./civil-punishment-reduce-table.component.scss'],
})
export class CivilPunishmentReduceTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    causeChangeEditAllIfy = {
        ...
        _loadEditFields: async () => {
            ...
            const scheme = await this.commonService
                .getFieldSchemeConent('cfjzgzyw_gwy01')
                .toPromise();
