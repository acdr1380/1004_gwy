...
import { CivilRetireTableComponent } from './civil-retire-table.component';
...
@NgModule({
    declarations: [CivilRetireTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [CivilRetireTableComponent],
})
export class CivilRetireTableModule {}
