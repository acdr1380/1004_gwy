...
import { SalaryPostListComponent } from './salary-post-list.component';
...
@NgModule({
    declarations: [SalaryPostListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryPostListComponent],
})
export class SalaryPostListModule {}
