...
@Component({
    selector: 'gl-salary-civil-allowance-change-list',
    templateUrl: './salary-civil-allowance-change-list.component.html',
    styleUrls: ['./salary-civil-allowance-change-list.component.scss'],
    providers: [WfTableHelper],
})
export class SalaryCivilAllowanceChangeListComponent implements OnInit {
    constructor(
