...
@Component({
    selector: 'gl-salary-civil-retire-start',
    templateUrl: './salary-civil-retire-start.component.html',
    styleUrls: ['./salary-civil-retire-start.component.scss'],
})
export class SalaryCivilRetireStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
