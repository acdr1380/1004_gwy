...
@Component({
    ...
    selector: 'salary-inner-transfer-person-file',
    templateUrl: './salary-inner-transfer-person-file.component.html',
    styleUrls: ['./salary-inner-transfer-person-file.component.scss'],
})
export class SalaryInnerTransferPersonFileComponent implements OnInit {
    /**
     * 业务是否可编辑
     */
    canEdit = false;
