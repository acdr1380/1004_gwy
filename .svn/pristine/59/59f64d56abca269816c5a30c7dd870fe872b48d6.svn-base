...
@Component({
    selector: 'gl-salary-retire-list',
    templateUrl: './salary-retire-list.component.html',
    styleUrls: ['./salary-retire-list.component.scss'],
})
export class SalaryRetireListComponent implements OnInit, AfterViewInit {
    constructor(
    ...
    formListIfy = {
        ...
        list: [
            ...
            {
                name: '机关事业单位退休（职）人员基本工资调整审批表',
                tag: 'b2',
                permission: 'wagechange_tuixiu001',
            },
        ],
        evtChange: ({ index }) => {
