...
@Component({
    ...
    selector: 'salary-initialize-wfinfo-drawer',
    templateUrl: './salary-initialize-drawer.component.html',
    styleUrls: ['./salary-initialize-drawer.component.scss']
})
export class SalaryInitializeDrawerComponent implements OnInit {
