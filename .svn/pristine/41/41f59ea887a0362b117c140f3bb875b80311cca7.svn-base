...
import { SalaryRetireTableComponent } from './salary-retire-table.component';
...
@NgModule({
    declarations: [SalaryRetireTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryRetireTableComponent],
})
export class SalaryRetireTableModule { }
