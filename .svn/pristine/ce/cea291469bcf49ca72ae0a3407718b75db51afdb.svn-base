...
@Component({
    selector: 'app-civil-punishment-reduce-start',
    templateUrl: './civil-punishment-reduce-start.component.html',
    styleUrls: ['./civil-punishment-reduce-start.component.scss'],
})
export class CivilPunishmentReduceStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
