...
import { SalaryPostTableComponent } from './salary-post-table.component';
...
@NgModule({
    declarations: [SalaryPostTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryPostTableComponent],
})
export class SalaryPostTableModule {}
