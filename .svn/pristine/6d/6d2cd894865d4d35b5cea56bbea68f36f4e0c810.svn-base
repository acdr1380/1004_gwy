...
import { SalaryFloatingChangeService } from '../salary-floating-change.service';
...
@Component({
    selector: 'gl-salary-floating-change-manager',
    templateUrl: './salary-floating-change-manager.component.html',
    styleUrls: ['./salary-floating-change-manager.component.scss'],
})
export class SalaryFloatingChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryFloatingChangeService,
