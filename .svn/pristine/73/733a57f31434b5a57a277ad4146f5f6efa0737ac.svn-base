...
import { StandingChangeListComponent } from './standing-change-list.component';
...
@NgModule({
    declarations: [StandingChangeListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [StandingChangeListComponent],
})
export class StandingChangeListModule { }
