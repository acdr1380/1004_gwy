...
import { LevelRiseTableComponent } from './level-rise-table.component';
...
@NgModule({
    declarations: [LevelRiseTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [LevelRiseTableComponent],
})
export class LevelRiseTableModule {}
