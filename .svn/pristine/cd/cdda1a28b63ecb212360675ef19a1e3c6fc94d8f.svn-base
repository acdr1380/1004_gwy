...
@Component({
    selector: 'gl-civil-retire-table',
    templateUrl: './civil-retire-table.component.html',
    styleUrls: ['./civil-retire-table.component.scss'],
})
export class CivilRetireTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    raiseRetireRatio = {
         ...
         */
        filterPersonRecord: () => {
            // const { DATA_PERSON_A01_ID } = this.raiseRetireRatio.selectPerson;
