...
import { SalarySickLeaveTableComponent } from './salary-sick-leave-table.component';

@NgModule({
    declarations: [SalarySickLeaveTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalarySickLeaveTableComponent],
})
export class SalarySickLeaveTableModule {}
