...
import { SalaryCivilDeathTableComponent } from './salary-civil-death-table.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryCivilDeathTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryCivilDeathTableComponent],
})
export class SalaryCivilDeathTableModule {}
