...
import { SalaryDefineLevelService } from '../salary-define-level.service';
...
@Component({
    selector: 'gl-salary-define-level-manager',
    templateUrl: './salary-define-level-manager.component.html',
    styleUrls: ['./salary-define-level-manager.component.scss'],
})
export class SalaryDefineLevelManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryDefineLevelService,
