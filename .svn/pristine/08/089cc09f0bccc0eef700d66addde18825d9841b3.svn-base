...
import { ExamRecordTableComponent } from './exam-record-table.component';
...
@NgModule({
    declarations: [ExamRecordTableComponent, ExamAdjustChildOrderComponent],
    imports: [
        CommonModule,
        CommonModule,
        ScrollingModule,
    ...
    exports: [ExamRecordTableComponent],
})
export class ExamRecordTableModule {}
