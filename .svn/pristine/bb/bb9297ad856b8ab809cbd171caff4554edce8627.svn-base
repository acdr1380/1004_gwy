...
@Component({
    selector: 'gl-salary-floating-change-table',
    templateUrl: './salary-floating-change-table.component.html',
    styleUrls: ['./salary-floating-change-table.component.scss'],
})
export class SalaryFloatingChangeTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
