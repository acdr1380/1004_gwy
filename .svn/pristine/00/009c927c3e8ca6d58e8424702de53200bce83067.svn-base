...
import { CivilPunishmentReduceTableComponent } from './civil-punishment-reduce-table.component';
...
@NgModule({
    declarations: [CivilPunishmentReduceTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [CivilPunishmentReduceTableComponent],
})
export class CivilPunishmentReduceTableModule {}
