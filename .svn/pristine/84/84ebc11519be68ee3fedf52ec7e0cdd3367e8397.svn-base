...
@Component({
    ...
    selector: 'civil-punishment-reduce-list',
    templateUrl: './civil-punishment-reduce-list.component.html',
    styleUrls: ['./civil-punishment-reduce-list.component.scss'],
})
export class CivilPunishmentReduceListComponent implements OnInit, AfterViewInit {
    constructor(
