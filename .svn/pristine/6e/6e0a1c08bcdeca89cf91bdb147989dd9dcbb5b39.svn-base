...
@Component({
    ...
    selector: 'civil-inner-transfer-person-file',
    templateUrl: './inner-transfer-person-file.component.html',
    styleUrls: ['./inner-transfer-person-file.component.scss']
})
export class InnerTransferPersonFileComponent implements OnInit {
