...
@Component({
    selector: 'gl-tibet-level-rise-manager',
    templateUrl: './tibet-level-rise-manager.component.html',
    styleUrls: ['./tibet-level-rise-manager.component.scss'],
})
export class TibetLevelRiseManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
