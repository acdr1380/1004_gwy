...
@Component({
    selector: 'gl-salary-civil-sick-leave-list',
    templateUrl: './salary-civil-sick-leave-list.component.html',
    styleUrls: ['./salary-civil-sick-leave-list.component.scss'],
})
export class SalaryCivilSickLeaveListComponent implements OnInit {
    constructor(
