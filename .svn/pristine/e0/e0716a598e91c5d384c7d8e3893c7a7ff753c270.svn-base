...
import { StandingChangeTableComponent } from './standing-change-table.component';
import { WorkChangeModule } from '../work-change/work-change.module';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [StandingChangeTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [StandingChangeTableComponent],
})
export class StandingChangeTableModule { }
