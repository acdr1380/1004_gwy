...
import { SalaryPostChangeService } from '../salary-post-change.service';
...
@Component({
    selector: 'gl-salary-post-change-manager',
    templateUrl: './salary-post-change-manager.component.html',
    styleUrls: ['./salary-post-change-manager.component.scss'],
})
export class SalaryPostChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryPostChangeService,
