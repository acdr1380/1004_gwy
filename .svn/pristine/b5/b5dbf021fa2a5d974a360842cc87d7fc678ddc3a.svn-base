...
import { SalaryRetireListComponent } from './salary-retire-list.component';
...
@NgModule({
    declarations: [SalaryRetireListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryRetireListComponent],
})
export class SalaryRetireListModule { }
