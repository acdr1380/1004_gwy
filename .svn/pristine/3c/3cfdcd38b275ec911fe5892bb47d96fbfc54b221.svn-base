...
@Component({
    selector: 'gl-salary-civil-sick-leave-start',
    templateUrl: './salary-civil-sick-leave-start.component.html',
    styleUrls: ['./salary-civil-sick-leave-start.component.scss'],
})
export class SalaryCivilSickLeaveStartComponent implements OnInit {
    /**
     * 路由参数
     */
