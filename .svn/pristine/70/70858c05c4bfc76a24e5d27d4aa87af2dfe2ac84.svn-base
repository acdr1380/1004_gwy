...
@Component({
    selector: 'gl-standing-change-manager',
    templateUrl: './standing-change-manager.component.html',
    styleUrls: ['./standing-change-manager.component.scss'],
})
export class StandingChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
