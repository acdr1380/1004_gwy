...
@Component({
    selector: 'gl-salary-civil-other-reduce-start',
    templateUrl: './salary-civil-other-reduce-start.component.html',
    styleUrls: ['./salary-civil-other-reduce-start.component.scss'],
})
export class SalaryCivilOtherReduceStartComponent implements OnInit {
    /**
     * 路由参数
     */
