...
@Component({
    selector: 'gl-salary-high-low-list',
    templateUrl: './salary-high-low-list.component.html',
    styleUrls: ['./salary-high-low-list.component.scss'],
})
export class SalaryHighLowListComponent implements OnInit {
    constructor(
    ...
    personFormIfy = {
        ...
        _setParams: () => {
            ...
            this.personFormIfy[`${this.tableHelper.getTableCode('A01')}_ID`] = keyId;
        },
        evtDataChange: event => {
