...
@Component({
    selector: 'gl-salary-level-rise-manager',
    templateUrl: './salary-level-rise-manager.component.html',
    styleUrls: ['./salary-level-rise-manager.component.scss'],
})
export class SalaryLevelRiseManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
