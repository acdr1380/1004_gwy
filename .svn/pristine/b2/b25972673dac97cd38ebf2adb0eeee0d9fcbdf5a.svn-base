...
@Component({
    selector: 'gl-salary-civil-death-table',
    templateUrl: './salary-civil-death-table.component.html',
    styleUrls: ['./salary-civil-death-table.component.scss'],
})
export class SalaryCivilDeathTableComponent implements OnInit {
    isFullScreen = false;
    ...
    private loadPersonTable() {
        ...
        this.workflowService.getWfListData(data).subscribe(result => {
            this.personTableIfy.data = result.map(d => {
                return {
                    ...d,
                };
            });
