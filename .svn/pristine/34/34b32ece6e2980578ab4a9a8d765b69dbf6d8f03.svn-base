...
import { PunishmentTableComponent } from './punishment-table.component';
...
@NgModule({
    declarations: [PunishmentTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [PunishmentTableComponent],
})
export class PunishmentTableModule { }
