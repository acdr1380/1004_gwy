...
@Component({
    selector: 'gl-salary-civil-sick-leave-manager',
    templateUrl: './salary-civil-sick-leave-manager.component.html',
    styleUrls: ['./salary-civil-sick-leave-manager.component.scss'],
})
export class SalaryCivilSickLeaveManagerComponent implements OnInit {
    /**
     * 路由参数
     */
