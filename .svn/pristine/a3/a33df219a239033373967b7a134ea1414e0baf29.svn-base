...
import { SalaryCivilAllowanceChangeListComponent } from './salary-civil-allowance-change-list.component';

@NgModule({
    declarations: [SalaryCivilAllowanceChangeListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilAllowanceChangeListComponent],
})
export class SalaryCivilAllowanceChangeListModule {}
