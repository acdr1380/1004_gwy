...
@Component({
    ...
    selector: 'civil-high-low-list',
    templateUrl: './civil-high-low-list.component.html',
    styleUrls: ['./civil-high-low-list.component.scss'],
})
export class CivilHighLowListComponent implements OnInit, AfterViewInit {
    constructor(
