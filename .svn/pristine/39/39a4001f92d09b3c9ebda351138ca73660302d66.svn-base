...
import { SalaryCivilDeathListComponent } from './salary-civil-death-list.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryCivilDeathListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilDeathListComponent],
})
export class SalaryCivilDeathListModule {}
