...
@Component({
    selector: 'gl-salary-post-change-start',
    templateUrl: './salary-post-change-start.component.html',
    styleUrls: ['./salary-post-change-start.component.scss'],
})
export class SalaryPostChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
