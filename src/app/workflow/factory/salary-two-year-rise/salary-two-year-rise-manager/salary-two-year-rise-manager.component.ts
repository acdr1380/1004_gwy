...
@Component({
    ...
    templateUrl: './salary-two-year-rise-manager.component.html',
    styleUrls: ['./salary-two-year-rise-manager.component.scss'],
})
export class SalaryTwoYearRiseManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
