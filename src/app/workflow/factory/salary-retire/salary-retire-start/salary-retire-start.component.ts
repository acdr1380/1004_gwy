...
@Component({
    selector: 'gl-salary-retire-start',
    templateUrl: './salary-retire-start.component.html',
    styleUrls: ['./salary-retire-start.component.scss'],
})
export class SalaryRetireStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
