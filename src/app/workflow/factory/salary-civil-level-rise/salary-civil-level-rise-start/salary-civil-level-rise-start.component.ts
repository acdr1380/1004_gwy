...
@Component({
    ...
    templateUrl: './salary-Civil-level-rise-start.component.html',
    styleUrls: ['./salary-Civil-level-rise-start.component.scss'],
})
export class SalaryCivilLevelRiseStartComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
