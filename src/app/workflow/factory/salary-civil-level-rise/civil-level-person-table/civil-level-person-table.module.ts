...
import { CivilLevelPersonTableComponent } from './civil-level-person-table.component';
...
@NgModule({
    declarations: [CivilLevelPersonTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [CivilLevelPersonTableComponent],
})
export class CivilLevelPersonTableModule { }
