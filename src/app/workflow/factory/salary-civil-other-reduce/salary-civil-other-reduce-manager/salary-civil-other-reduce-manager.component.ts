...
@Component({
    selector: 'gl-salary-civil-other-reduce-manager',
    templateUrl: './salary-civil-other-reduce-manager.component.html',
    styleUrls: ['./salary-civil-other-reduce-manager.component.scss'],
})
export class SalaryCivilOtherReduceManagerComponent implements OnInit {
    /**
     * 路由参数
     */
