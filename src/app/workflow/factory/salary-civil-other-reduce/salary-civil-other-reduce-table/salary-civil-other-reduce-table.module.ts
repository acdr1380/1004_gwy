...
import { SalaryCivilOtherReduceTableComponent } from './salary-civil-other-reduce-table.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryCivilOtherReduceTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryCivilOtherReduceTableComponent],
})
export class SalaryCivilOtherReduceTableModule {}
