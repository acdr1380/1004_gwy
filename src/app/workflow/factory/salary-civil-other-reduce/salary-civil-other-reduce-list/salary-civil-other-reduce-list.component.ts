...
@Component({
    selector: 'gl-salary-civil-other-reduce-list',
    templateUrl: './salary-civil-other-reduce-list.component.html',
    styleUrls: ['./salary-civil-other-reduce-list.component.scss'],
})
export class SalaryCivilOtherReduceListComponent implements OnInit, AfterViewInit {
    constructor(
    ...
    formListIfy = {
        ...
        list: [
            ...
            },
            {
                name: '机关事业单位工资转移介绍信',
                tag: 'b2',
                permission: 'transfer_ietter_xin',
            },
            {
