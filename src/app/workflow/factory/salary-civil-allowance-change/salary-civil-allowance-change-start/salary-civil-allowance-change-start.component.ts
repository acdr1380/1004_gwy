...
@Component({
    selector: 'gl-salary-civil-allowance-change-start',
    templateUrl: './salary-civil-allowance-change-start.component.html',
    styleUrls: ['./salary-civil-allowance-change-start.component.scss'],
})
export class SalaryCivilAllowanceChangeStartComponent implements OnInit {
    /**
     * 路由参数
     */
