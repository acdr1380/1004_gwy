...
@Component({
    ...
    templateUrl: './rank-rise-start.component.html',
    styleUrls: ['./rank-rise-start.component.scss'],
})
export class RankRiseStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
