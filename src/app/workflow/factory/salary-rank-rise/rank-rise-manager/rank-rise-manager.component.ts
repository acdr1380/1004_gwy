...
import { SalaryRankRiseService } from '../salary-rank-rise.service';
...
@Component({
    selector: 'app-rank-rise-manager',
    templateUrl: './rank-rise-manager.component.html',
    styleUrls: ['./rank-rise-manager.component.scss'],
})
export class RankRiseManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryRankRiseService,
