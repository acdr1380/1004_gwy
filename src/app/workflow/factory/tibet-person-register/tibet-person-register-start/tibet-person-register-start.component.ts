...
@Component({
    selector: 'gl-tibet-person-register-start',
    templateUrl: './tibet-person-register-start.component.html',
    styleUrls: ['./tibet-person-register-start.component.scss'],
})
export class TibetPersonRegisterStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
