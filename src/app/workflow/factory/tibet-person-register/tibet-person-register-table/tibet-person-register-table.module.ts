...
import { TibetPersonRegisterTableComponent } from './tibet-person-register-table.component';
...
@NgModule({
    declarations: [TibetPersonRegisterTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [TibetPersonRegisterTableComponent],
})
export class TibetPersonRegisterTableModule { }
