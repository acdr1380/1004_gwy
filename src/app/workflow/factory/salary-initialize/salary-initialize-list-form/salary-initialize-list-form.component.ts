...
@Component({
    ...
    selector: 'salary-initialize-list-form',
    templateUrl: './salary-initialize-list-form.component.html',
    styleUrls: ['./salary-initialize-list-form.component.scss'],
})
export class SalaryInitializeListFormComponent implements OnInit, AfterViewInit {
    constructor(
