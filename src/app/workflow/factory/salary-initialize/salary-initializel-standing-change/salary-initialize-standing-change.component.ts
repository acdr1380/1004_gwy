...
@Component({
    ...
    selector: 'salary-initialize-standing-change',
    templateUrl: './salary-initialize-standing-change.component.html',
    styleUrls: ['./salary-initialize-standing-change.component.scss'],
})
export class SalaryInitializeStandingChangeComponent implements OnInit {
    /**
     * 业务信息
     */
    ...
    constructor(
        ...
        private innerTable: SalaryInitializePersonTableComponent,
