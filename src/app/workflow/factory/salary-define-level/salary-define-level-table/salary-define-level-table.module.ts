...
import { SalaryDefineLevelTableComponent } from './salary-define-level-table.component';
...
@NgModule({
    declarations: [SalaryDefineLevelTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryDefineLevelTableComponent],
})
export class SalaryDefineLevelTableModule { }
