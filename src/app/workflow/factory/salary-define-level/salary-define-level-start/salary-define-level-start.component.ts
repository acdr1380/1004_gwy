...
@Component({
    selector: 'gl-salary-define-level-start',
    templateUrl: './salary-define-level-start.component.html',
    styleUrls: ['./salary-define-level-start.component.scss'],
})
export class SalaryDefineLevelStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
