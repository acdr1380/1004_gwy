...
import { SalaryDefineLevelListComponent } from './salary-define-level-list.component';
...
@NgModule({
    declarations: [SalaryDefineLevelListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryDefineLevelListComponent],
})
export class SalaryDefineLevelListModule { }
