...
@Component({
    selector: 'app-salary-civli-inner-transfer-start',
    templateUrl: './salary-civli-inner-transfer-start.component.html',
    styleUrls: ['./salary-civli-inner-transfer-start.component.scss'],
})
export class SalaryCivliInnerTransferStartComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
    ...
    private async loadUserContacts() {
        ...
        this.commonService.getUserInfoByCache().then((userInfo: any) => {
            if (!contacts) {
