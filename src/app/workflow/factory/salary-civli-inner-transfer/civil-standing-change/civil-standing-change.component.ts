...
@Component({
    ...
    templateUrl: './civil-standing-change.component.html',
    styleUrls: ['./civil-standing-change.component.scss'],
})
export class CivilStandingChangeComponent implements OnInit {
    /**
     * 业务信息
     */
    ...
    constructor(
        ...
        private innerTable: InnerTransferPersonTableComponent,
