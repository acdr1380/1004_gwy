...
import { SalaryCivilDefineLevelListComponent } from './salary-civil-define-level-list.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryCivilDefineLevelListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilDefineLevelListComponent],
})
export class SalaryCivilDefineLevelListModule {}
