...
import { SalaryCivilDefineLevelTableComponent } from './salary-civil-define-level-table.component';

@NgModule({
    declarations: [SalaryCivilDefineLevelTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryCivilDefineLevelTableComponent],
})
export class SalaryCivilDefineLevelTableModule {}
