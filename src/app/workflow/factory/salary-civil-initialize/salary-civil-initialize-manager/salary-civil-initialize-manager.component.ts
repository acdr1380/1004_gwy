...
@Component({
    selector: 'app-salary-civil-initialize-manager',
    templateUrl: './salary-civil-initialize-manager.component.html',
    styleUrls: ['./salary-civil-initialize-manager.component.scss'],
})
export class SalaryCivilInitializeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
