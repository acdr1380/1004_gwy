...
import { AllowFields } from '../salary-civil-initialize-allowance-field/fields';
...
@Component({
    ...
    selector: 'salary-civil-initialize-allow-edit',
    templateUrl: './salary-civil-initialize-allow-edit.component.html',
    styleUrls: ['./salary-civil-initialize-allow-edit.component.scss'],
})
export class SalaryCivilInitializeAllowEditComponent implements OnInit {
    constructor(
        private workflowService: WorkflowService,
        private modalService: NzModalService,
        private parentService: SalaryCivilInitializeService,
