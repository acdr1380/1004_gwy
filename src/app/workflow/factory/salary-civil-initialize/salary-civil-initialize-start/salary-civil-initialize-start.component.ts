...
@Component({
    selector: 'app-salary-civil-initialize-start',
    templateUrl: './salary-civil-initialize-start.component.html',
    styleUrls: ['./salary-civil-initialize-start.component.scss'],
})
export class SalaryCivilInitializeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    constructor(
