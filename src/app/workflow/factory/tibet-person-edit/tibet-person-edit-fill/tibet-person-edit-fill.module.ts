...
import { TibetPersonEditFillComponent } from './tibet-person-edit-fill.component';
@NgModule({
    declarations: [
        TibetPersonEditFillComponent,
    ...
    providers: [],
    exports: [TibetPersonEditFillComponent],
})
export class TibetPersonEditFillModule { }
