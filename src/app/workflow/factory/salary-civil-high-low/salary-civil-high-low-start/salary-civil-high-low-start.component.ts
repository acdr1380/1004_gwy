...
@Component({
    selector: 'app-civil-high-low-start',
    templateUrl: './salary-civil-high-low-start.component.html',
    styleUrls: ['./salary-civil-high-low-start.component.scss'],
})
export class SalaryCivilHighLowStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
