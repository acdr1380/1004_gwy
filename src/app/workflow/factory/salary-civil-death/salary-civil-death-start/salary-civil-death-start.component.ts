...
@Component({
    selector: 'gl-salary-civil-death-start',
    templateUrl: './salary-civil-death-start.component.html',
    styleUrls: ['./salary-civil-death-start.component.scss'],
})
export class SalaryCivilDeathStartComponent implements OnInit {
    /**
     * 路由参数
     */
