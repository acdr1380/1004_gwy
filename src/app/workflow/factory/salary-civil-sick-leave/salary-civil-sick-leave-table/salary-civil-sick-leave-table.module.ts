...
import { CameraCZURModule } from 'app/components/camera-czur/camera-czur.module';
import { NzRadioModule } from 'ng-zorro-antd/radio';
import { SalaryCivilSickLeaveTableComponent } from './salary-civil-sick-leave-table.component';

@NgModule({
    declarations: [SalaryCivilSickLeaveTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilSickLeaveTableComponent],
})
export class SalaryCivilSickLeaveTableModule {}
