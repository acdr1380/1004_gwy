...
import { SalaryCivilSickLeaveListComponent } from './salary-civil-sick-leave-list.component';

@NgModule({
    declarations: [SalaryCivilSickLeaveListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryCivilSickLeaveListComponent],
})
export class SalaryCivilSickLeaveListModule {}
