...
@Component({
    ...
    selector: 'civil-education-table',
    templateUrl: './civil-education-table.component.html',
    styleUrls: ['./civil-education-table.component.scss'],
})
export class CivilEducationTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
    ...
    causeChangeEditAllIfy = {
        ...
        _loadEditFields: async () => {
            ...
            const scheme = await this.commonService
                .getFieldSchemeConent('xlbdgzyw_gwy01')
                .toPromise();
