...
@Component({
    selector: 'app-civil-post-change-start',
    templateUrl: './civil-education-change-start.component.html',
    styleUrls: ['./civil-education-change-start.component.scss'],
})
export class CivilEducationChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
