...
@Component({
    ...
    selector: 'civil-education-list',
    templateUrl: './civil-education-list.component.html',
    styleUrls: ['./civil-education-list.component.scss'],
})
export class CivilEducationListComponent implements OnInit, AfterViewInit {
    constructor(
