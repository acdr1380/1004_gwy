...
@Component({
    selector: 'gl-salary-sick-leave-list',
    templateUrl: './salary-sick-leave-list.component.html',
    styleUrls: ['./salary-sick-leave-list.component.scss'],
})
export class SalarySickLeaveListComponent implements OnInit {
    constructor(
