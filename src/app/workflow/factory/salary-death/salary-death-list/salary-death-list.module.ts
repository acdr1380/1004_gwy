...
import { SalaryDeathListComponent } from './salary-death-list.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';

@NgModule({
    declarations: [SalaryDeathListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryDeathListComponent],
})
export class SalaryDeathListModule { }
