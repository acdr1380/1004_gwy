...
@Component({
    selector: 'gl-salary-death-list',
    templateUrl: './salary-death-list.component.html',
    styleUrls: ['./salary-death-list.component.scss'],
})
export class SalaryDeathListComponent implements OnInit {
    constructor(
