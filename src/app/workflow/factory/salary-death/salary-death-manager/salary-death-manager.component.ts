...
import { SalaryDeathService } from '../salary-death.service';

@Component({
    selector: 'gl-salary-death-manager',
    templateUrl: './salary-death-manager.component.html',
    styleUrls: ['./salary-death-manager.component.scss'],
})
export class SalaryDeathManagerComponent implements OnInit {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryDeathService,
