...
@Component({
    selector: 'gl-salary-other-reduce-start',
    templateUrl: './salary-other-reduce-start.component.html',
    styleUrls: ['./salary-other-reduce-start.component.scss'],
})
export class SalaryOtherReduceStartComponent implements OnInit {
    /**
     * 路由参数
     */
