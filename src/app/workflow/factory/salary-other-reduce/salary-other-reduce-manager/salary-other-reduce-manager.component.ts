...
@Component({
    selector: 'gl-salary-other-reduce-manager',
    templateUrl: './salary-other-reduce-manager.component.html',
    styleUrls: ['./salary-other-reduce-manager.component.scss'],
})
export class SalaryOtherReduceManagerComponent implements OnInit {
    /**
     * 路由参数
     */
