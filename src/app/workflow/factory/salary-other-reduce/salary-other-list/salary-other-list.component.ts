...
@Component({
    selector: 'gl-salary-other-list',
    templateUrl: './salary-other-list.component.html',
    styleUrls: ['./salary-other-list.component.scss'],
})
export class SalaryOtherListComponent implements OnInit {
    constructor(
