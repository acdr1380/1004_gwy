...
@Component({
    selector: 'gl-tibet-person-initialize-table',
    templateUrl: './tibet-person-initialize-table.component.html',
    styleUrls: ['./tibet-person-initialize-table.component.scss'],
})
export class TibetPersonInitializeTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
