...
@Component({
    selector: 'gl-tibet-person-initialize-fill',
    templateUrl: './tibet-person-initialize-fill.component.html',
    styleUrls: ['./tibet-person-initialize-fill.component.scss'],
})
export class TibetPersonInitializeFillComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
