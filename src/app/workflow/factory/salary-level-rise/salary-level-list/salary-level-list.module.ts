...
import { SalaryLevelListComponent } from './salary-level-list.component';
...
@NgModule({
    declarations: [SalaryLevelListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [SalaryLevelListComponent],
})
export class SalaryLeveltListModule {}
