...
@Component({
    selector: 'gl-salary-level-rise-start',
    templateUrl: './salary-level-rise-start.component.html',
    styleUrls: ['./salary-level-rise-start.component.scss'],
})
export class SalaryLevelRiseStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
