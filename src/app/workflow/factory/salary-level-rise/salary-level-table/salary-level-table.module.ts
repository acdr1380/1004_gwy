...
import { SalaryLevelTableComponent } from './salary-level-table.component';
...
@NgModule({
    declarations: [SalaryLevelTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryLevelTableComponent],
})
export class SalaryLevelTableModule { }
