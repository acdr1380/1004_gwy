...
@Component({
    selector: 'gl-salary-education-change-start',
    templateUrl: './salary-education-change-start.component.html',
    styleUrls: ['./salary-education-change-start.component.scss'],
})
export class SalaryEducationChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
