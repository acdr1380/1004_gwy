...
import { SalaryEducationChangeTableComponent } from './salary-education-change-table.component';
...
@NgModule({
    declarations: [SalaryEducationChangeTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [SalaryEducationChangeTableComponent],
})
export class SalaryEducationChangeTableModule { }
