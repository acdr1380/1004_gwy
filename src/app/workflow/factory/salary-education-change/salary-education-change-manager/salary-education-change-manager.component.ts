...
import { SalaryEducationChangeService } from '../salary-education-change.service';
...
@Component({
    selector: 'gl-salary-education-change-manager',
    templateUrl: './salary-education-change-manager.component.html',
    styleUrls: ['./salary-education-change-manager.component.scss'],
})
export class SalaryEducationChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryEducationChangeService,
