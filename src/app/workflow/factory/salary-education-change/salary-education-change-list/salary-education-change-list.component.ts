...
@Component({
    selector: 'gl-salary-education-change-list',
    templateUrl: './salary-education-change-list.component.html',
    styleUrls: ['./salary-education-change-list.component.scss'],
})
export class SalaryEducationChangeListComponent implements OnInit, AfterViewInit {
    constructor(
