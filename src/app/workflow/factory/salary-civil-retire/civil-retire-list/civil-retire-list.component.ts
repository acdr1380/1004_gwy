...
@Component({
    selector: 'gl-civil-retire-list',
    templateUrl: './civil-retire-list.component.html',
    styleUrls: ['./civil-retire-list.component.scss'],
})
export class CivilRetireListComponent implements OnInit, AfterViewInit {
    constructor(
