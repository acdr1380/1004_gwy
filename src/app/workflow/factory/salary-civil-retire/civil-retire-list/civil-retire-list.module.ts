...
import { CivilRetireListComponent } from './civil-retire-list.component';
...
@NgModule({
    declarations: [CivilRetireListComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [CivilRetireListComponent],
})
export class CivilRetireListModule {}
