...
@Component({
    selector: 'gl-tibet-annual-assess-manager',
    templateUrl: './tibet-annual-assess-manager.component.html',
    styleUrls: ['./tibet-annual-assess-manager.component.scss']
})
export class TibetAnnualAssessManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
