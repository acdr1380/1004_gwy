...
@Component({
    selector: 'gl-allowance-change-manager',
    templateUrl: './allowance-change-manager.component.html',
    styleUrls: ['./allowance-change-manager.component.scss'],
})
export class AllowanceChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
