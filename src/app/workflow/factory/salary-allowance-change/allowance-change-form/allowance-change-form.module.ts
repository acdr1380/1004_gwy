...
import { AllowanceChangeFormComponent } from './allowance-change-form.component';
import { SalaryGZDA07JBTModule } from 'app/components/salary-gzda07-jbt/salary-gzda07-jbt.module';


@NgModule({
    declarations: [AllowanceChangeFormComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [AllowanceChangeFormComponent],
})
export class AllowanceChangeFormModule { }
