...
import { AllowanceChangeTableComponent } from './allowance-change-table.component';
import { CareerAllowEditComponent } from './career-allow-edit/career-allow-edit.component';

@NgModule({
    declarations: [AllowanceChangeTableComponent, CareerAllowEditComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [AllowanceChangeTableComponent],
})
export class AllowanceChangeTableModule {}
