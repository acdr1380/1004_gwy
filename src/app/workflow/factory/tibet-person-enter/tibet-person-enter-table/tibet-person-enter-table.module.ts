...
import { TibetPersonEnterTableComponent } from './tibet-person-enter-table.component';
...
@NgModule({
    declarations: [TibetPersonEnterTableComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    providers: [DatePipe],
    exports: [TibetPersonEnterTableComponent],
})
export class TibetPersonEnterTableModule {}
