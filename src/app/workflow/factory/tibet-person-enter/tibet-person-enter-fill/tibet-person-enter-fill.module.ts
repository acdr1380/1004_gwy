...
import { TibetPersonEnterFillComponent } from './tibet-person-enter-fill.component';
...
import { TibetPersonEnterFileModule } from '../tibet-person-enter-file/tibet-person-enter-file.module';

@NgModule({
    declarations: [TibetPersonEnterFillComponent, PersonCheckComponent, AdjustChildOrderComponent],
    imports: [
        CommonModule,
        ScrollingModule,
        FormsModule,
    ...
    exports: [TibetPersonEnterFillComponent],
})
export class TibetPersonEnterFillModule {}
