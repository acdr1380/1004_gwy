...
@Component({
  selector: 'gl-tibet-person-enter-manager',
  templateUrl: './tibet-person-enter-manager.component.html',
  styleUrls: ['./tibet-person-enter-manager.component.scss']
})
export class TibetPersonEnterManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
