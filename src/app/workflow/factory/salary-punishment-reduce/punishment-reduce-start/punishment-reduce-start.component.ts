...
@Component({
    selector: 'app-rank-rise-start',
    templateUrl: './punishment-reduce-start.component.html',
    styleUrls: ['./punishment-reduce-start.component.scss'],
})
export class PunishmentReduceStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
