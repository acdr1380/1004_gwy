...
import { SalaryPunishmentReduceService } from '../salary-punishment-reduce.service';
...
@Component({
    selector: 'app-punishment-reduce-manager',
    templateUrl: './punishment-reduce-manager.component.html',
    styleUrls: ['./punishment-reduce-manager.component.scss'],
})
export class PunishmentReduceManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryPunishmentReduceService,
