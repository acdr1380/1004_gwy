...
@Component({
    ...
    templateUrl: './civil-post-change-start.component.html',
    styleUrls: ['./civil-post-change-start.component.scss'],
})
export class CivilPostChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
