...
import { SalaryCivilPostChangeService } from '../salary-civil-post-change.service';
...
@Component({
    ...
    templateUrl: './civil-post-change-manager.component.html',
    styleUrls: ['./civil-post-change-manager.component.scss'],
})
export class CivilPostChangeManagerComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryCivilPostChangeService,
