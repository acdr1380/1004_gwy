...
@Component({
    ...
    selector: 'civil-post-table',
    templateUrl: './civil-post-table.component.html',
    styleUrls: ['./civil-post-table.component.scss'],
})
export class CivilPostTableComponent implements OnInit, AfterViewInit {
    isFullScreen = false;
