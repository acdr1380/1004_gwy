...
import { SalaryInnerTransferDrawerComponent } from '../salary-inner-transfer-drawer/salary-inner-transfer-drawer.component';
import { IsTeacherTableComponent } from '../is-teacher-table/is-teacher-table.component';
import { WfTableHelper } from 'app/util/classes/wf-table-helper';

@Component({
    // tslint:disable-next-line: component-selector
    selector: 'salary-inner-transfer-table',
...
export class TransferTableComponent implements OnInit, AfterViewInit {
    ...
    _wfInfoDrawerElement: SalaryInnerTransferDrawerComponent;
