...
@Component({
    selector: 'gl-salary-high-low-table',
    templateUrl: './salary-high-low-table.component.html',
    styleUrls: ['./salary-high-low-table.component.scss'],
})
export class SalaryHighLowTableComponent implements OnInit {
    isFullScreen = false;
    ...
    causeChangeEditAllIfy = {
        ...
        _loadEditFields: async () => {
            ...
            const scheme = await this.commonService.getFieldSchemeConent('sygz_gddyw').toPromise();
        ...
        save: () => {
            ...
            if (this.commonService.formVerify(this.causeChangeEditAllIfy.form)) {
                const params: any = {
                    ...
                    tableId: `${this.tableHelper.getTableCode('GZ09')}`,
