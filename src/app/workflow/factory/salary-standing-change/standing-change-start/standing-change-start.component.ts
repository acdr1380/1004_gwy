...
import { SalaryStandingChangeService } from '../salary-standing-change.service';

@Component({
    selector: 'gl-standing-change-start',
    templateUrl: './standing-change-start.component.html',
    styleUrls: ['./standing-change-start.component.scss'],
})
export class StandingChangeStartComponent implements OnInit, AfterViewInit, OnDestroy {
    /**
     * 路由参数
     */
    ...
    constructor(
        ...
        private service: SalaryStandingChangeService,
