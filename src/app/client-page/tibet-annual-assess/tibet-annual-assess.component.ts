...
@Component({
    selector: 'gl-tibet-annual-assess',
    templateUrl: './tibet-annual-assess.component.html',
    styleUrls: ['./tibet-annual-assess.component.scss']
})
export class TibetAnnualAssessComponent implements OnInit, OnDestroy {
    /**
     * 用户信息
     */
    userInfo: any = {};
