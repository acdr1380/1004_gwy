...
import { PromotionQueryComponent } from './promotion-query.component';
...
const route: Routes = [{ path: '', component: PromotionQueryComponent }];
...
@NgModule({
    ...
    declarations: [PromotionQueryComponent],
})
export class PromotionQueryModule {}
